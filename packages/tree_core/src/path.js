import { newPadPathNode, toPathNode } from "./node.js";
import { Height, NodePosition } from "./position.js";
import { buildPathTree } from "./treeBuilder.js";
import { kdf } from "./kdf.js";
import { Bytes32 } from "./bytes.js";
export const generatePath = (treeStore, position, paddingNodeContent) => {
...
export const generateMerkleWitness = (treeStore, position, paddingNodeContent) => {
 ...
 */
export const generateProof = (treeStore, position) => {
